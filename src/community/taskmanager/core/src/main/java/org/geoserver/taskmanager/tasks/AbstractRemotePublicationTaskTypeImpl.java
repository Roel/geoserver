        ...
        try {
            ...
            for (StyleInfo si : createStyles) { // style doesn't exist yet, publish
                ...
                if (!restManager.getStyleManager().publishStyleZippedInWorkspace(
                        CatalogUtil.wsName(si.getWorkspace()), catalogUtil.createStyleZipFile(si),
                        si.getName())) {
            ...
            if (layer.getDefaultStyle() != null) {
                layerEncoder.setDefaultStyle(CatalogUtil.wsName(layer.getDefaultStyle().getWorkspace()),
            ...
            for (StyleInfo style : createStyles) {
                restManager.getPublisher().removeStyleInWorkspace(CatalogUtil.wsName(style.getWorkspace()),
                        style.getName(), true);
            }
